...
The dataset used for training the model is obtained from Kaggle and can be found [here]((https://www.kaggle.com/datasets/sameepvani/nasa-nearest-earth-objects)).
